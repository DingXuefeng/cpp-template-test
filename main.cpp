...
template <typename T> T convert(const std::string &v) {
...
template <> double convert(const std::string &v) { return std::stod(v); }

template <typename T> T A::get(const std::string &key) const {
